namespace ResourceReport.Models
{
    internal class Report
    {
        ...
        public Report(string contractName, string service, string description, string unit, string quantity, string serviceDeliveryTime, string serviceDownTime, string serviceAvailability, string pricePerUnit, string priceSum, string vAT, string vATSum)
        {
